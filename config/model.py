...
class ModelConfig(BaseSettings):
    ...
    zai_base_url: str = Field(default="", alias="ZAI_BASE_URL", description="Zai API Key")

    aliyun_api_key: str = Field(default="", alias="ALIYUN_API_KEY", description="AliYun API Key")
    aliyun_base_url: str = Field(default="", alias="ALIYUN_BASE_URL", description="AliYun API Key")